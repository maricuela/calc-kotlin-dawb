...
# Configuración
REPO_PATH = "../calc-kotlin-dawb"  # Ruta del repositorio local

COMMIT_INITIAL_MESSAGE = "Commit inicial"
COMMIT_DIVISION_ERROR_MESSAGE = "Función división con error"
COMMIT_DIVISION_MESSAGE = "Función división sin error"
COMMIT_SUMA_MESSAGE = "Función suma"
COMMIT_RESTA_MESSAGE = "Función resta"
...
for comment in COMMENTS:
    print(comment)
print(f"📊 Puntuación final {user_name}(DAWB): {TOTAL_SCORE}/100")